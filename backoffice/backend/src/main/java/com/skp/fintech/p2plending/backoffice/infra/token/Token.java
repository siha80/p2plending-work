...
public class Token implements Serializable {
    ...
    @JsonIgnore
    private static final Long DefaultPeriodSeconds = 60 * 60 * 1L;

    @Getter @Setter private String iss = "P2P-LENDING-BACKOFFICE";
    @Getter @Setter private String aud = "P2P-LENDING-BACKOFFICE";
