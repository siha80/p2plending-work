...
trait Json4sSupport {
  ...
  implicit def toJson[T <: AnyRef](data: T)(implicit formats: Formats): String = {
    jackson.Serialization.write(data)
  }

  implicit def toJsonForResponseEntity[T <: AnyRef](data: T)(implicit formats: Formats): ResponseEntity = {
    HttpEntity.apply(toJson(data))
  }
}
