...
name := "p2plending-backend-evaluation"
scalaVersion := "2.11.8"
...
test in assembly := {}
assemblyJarName in assembly := "p2plending-evaluation.jar"
mainClass in assembly := Some("com.skp.payment.p2plending.evaluation.launcher")
