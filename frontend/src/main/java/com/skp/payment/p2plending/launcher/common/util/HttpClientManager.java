...
public class HttpClientManager {
    public ClientResponse postRawData(String uri, Map<String, String> headerMap, String data) throws KeyManagementException, NoSuchAlgorithmException {
     ...
     * HTTPS 설정을 반환한다.
     *
     * @return {@link com.sun.jersey.api.client.config.ClientConfig}
     * @since 2015.02.13
     */
